...
class PlayPage():
    ...
    def check(self,position,station,keyboard):
    	...
    	if self.station=="down":
	    	if self.keyboard=="left":self.playerDirection="left"
	    	elif self.keyboard=="right":self.playerDirection="right"
	    	elif self.keyboard=="up":self.playerDirection="up"
	    	elif self.keyboard=="down":self.playerDirection="down"
